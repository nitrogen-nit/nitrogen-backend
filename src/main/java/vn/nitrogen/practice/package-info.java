/**
 * Module Practice — runtime của lượt làm bài: attempt, item, response, grading run, topic result.
 *
 ...
 *
 * <p>Sở hữu PostgreSQL schema {@code practice}. Module khác chỉ được chạm tới module
