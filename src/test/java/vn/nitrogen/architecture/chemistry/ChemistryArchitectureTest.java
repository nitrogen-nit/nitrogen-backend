package vn.nitrogen.architecture.chemistry;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code chemistry}.
 *
 ...
 */
class ChemistryArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.chemistry";
