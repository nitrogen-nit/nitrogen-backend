package vn.nitrogen.architecture.content;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code content}.
 *
 ...
 */
class ContentArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.content";
