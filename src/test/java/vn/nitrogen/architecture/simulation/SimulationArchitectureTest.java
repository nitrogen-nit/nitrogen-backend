package vn.nitrogen.architecture.simulation;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code simulation}.
 *
...
class SimulationArchitectureTest {
    ...
    private static final String MODULE_PACKAGE = "vn.nitrogen.simulation";
