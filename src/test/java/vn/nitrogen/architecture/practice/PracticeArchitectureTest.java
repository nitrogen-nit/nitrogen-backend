package vn.nitrogen.architecture.practice;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code practice}.
 *
 ...
 */
class PracticeArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.practice";
