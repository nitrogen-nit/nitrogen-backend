package vn.nitrogen.architecture.progress;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code progress}.
 *
...
class ProgressArchitectureTest {
    ...
    private static final String MODULE_PACKAGE = "vn.nitrogen.progress";
