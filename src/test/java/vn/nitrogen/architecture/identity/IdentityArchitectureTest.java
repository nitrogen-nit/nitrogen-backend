package vn.nitrogen.architecture.identity;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code identity}.
 *
...
class IdentityArchitectureTest {
    ...
    private static final String MODULE_PACKAGE = "vn.nitrogen.identity";
