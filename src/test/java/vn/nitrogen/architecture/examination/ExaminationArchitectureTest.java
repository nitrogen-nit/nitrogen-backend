package vn.nitrogen.architecture.examination;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code examination}.
 *
 ...
 */
class ExaminationArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.examination";
