package vn.nitrogen.architecture.integration;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code integration}.
 *
...
class IntegrationArchitectureTest {
    ...
    private static final String MODULE_PACKAGE = "vn.nitrogen.integration";
