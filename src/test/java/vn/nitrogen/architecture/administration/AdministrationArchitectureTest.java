package vn.nitrogen.architecture.administration;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code administration}.
 *
 ...
 */
class AdministrationArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.administration";
