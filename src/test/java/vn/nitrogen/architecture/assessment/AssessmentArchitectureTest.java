package vn.nitrogen.architecture.assessment;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code assessment}.
 *
 ...
 */
class AssessmentArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.assessment";
