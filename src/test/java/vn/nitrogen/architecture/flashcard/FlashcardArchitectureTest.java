package vn.nitrogen.architecture.flashcard;
...
/**
 * Toàn bộ luật kiến trúc áp cho module {@code flashcard}.
 *
 ...
 */
class FlashcardArchitectureTest {

    private static final String MODULE_PACKAGE = "vn.nitrogen.flashcard";
